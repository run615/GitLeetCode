...
public class main372 {
     ...
     */
    private int quickPow(int a, Integer k) {
        if (k == 0) {
            return 1;
        }
        if ((k & 1) == 1) {
            // k 是奇数
            return (a * quickPow(a, k - 1)) % base;
        } else {
